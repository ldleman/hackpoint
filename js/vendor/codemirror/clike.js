...
CodeMirror.defineMode("clike", function(config, parserConfig) {
  ...
  def(["text/x-carduino"], {
    name: "clike",
    keywords: words(cKeywords+" Serial Stream Keyboard Mouse class"),
    types: words(cTypes + " void boolean char unsigned char byte int unsigned int word long unsigned long short float double string String array"),
    blockKeywords: words("case break continue do goto return else for if switch while"),
    defKeywords: words("struct setup loop"),
  ...
  def(["text/x-csrc", "text/x-c", "text/x-chdr"], {
    name: "clike",
    keywords: words(cKeywords+" Serial Stream Keyboard Mouse"),
    types: words(cTypes + " void boolean char unsigned char byte int unsigned int word long unsigned long short float double string String array"),
